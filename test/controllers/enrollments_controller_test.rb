...
class EnrollmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enrollment" do
    assert_difference("Enrollment.count") do
      post enrollments_url, params: { enrollment: { status: @enrollment.status, waitlist_position: @enrollment.waitlist_position } }
    end
  ...
  test "should update enrollment" do
    patch enrollment_url(@enrollment), params: { enrollment: { status: @enrollment.status, waitlist_position: @enrollment.waitlist_position } }
